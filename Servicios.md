...
Salida:
- `lang`:`es|ca|en|fr|gl|it|pt|ru|de|none`
...
Argumentos: 
- `texto`:*texto de entrada*
- `tagset`:`penn|stts` (alemán)`|woten` (neerlandés)
...
Salida:
- `entidades`:*hash* con lista de tokens*
